// src/containers/CompletePayment/index.jsx
...
const STATUS_CONTENT_MAP = {
    succeeded: { text: "Pagamento realizado com sucesso!", iconColor: "#30B130", icon: SuccessIcon, buttonText: 'Voltar para a loja', url: '/' },
    processing: { text: "Seu pagamento está sendo processado.", iconColor: "#6D6E78", icon: InfoIcon, buttonText: 'Voltar para loja', url: '/' },
    requires_payment_method: { text: "Falha no pagamento, por favor tente novamente.", iconColor: "#DF1B41", icon: ErrorIcon, buttonText: 'Tentar novamente', url: '/carrinho' },
    default: { text: "Algo deu errado, por favor tente novamente.", iconColor: "#DF1B41", icon: ErrorIcon, buttonText: 'Tentar novamente', url: '/carrinho' },
};
